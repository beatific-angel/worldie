...
/*
 | Users table column and role table column you want to join WITH.
 |
 | Joins from users.id
 | Joins from roles.id
 */
...
$config['default_role']              = 'members';           // Default role, use name
$config['admin_role']                = 'admin';             // Default administrators role, use name
