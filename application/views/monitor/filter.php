              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="form-group">
                    <span class="c_span">Status</span>
                    <select name="pstatus" id="pstatus" required="" onchange="onchange_pstatus()">
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        "order": [],
        "ajax": {
            "url": "<?php echo base_url('monitor/filter_list')?>",
            "type": "POST",
            "data": function ( d ) {
              return $.extend( {}, d, {
