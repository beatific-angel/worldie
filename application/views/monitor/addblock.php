            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
				...
				?>
                  ...
                  <div class="x_content">
                    <br />
					<?php $attributes = array('name' => 'addblockform', 'class' => 'form-horizontal form-label-left', 'id' => 'addblockform');?>
					<?php echo form_open("monitor/addblock", $attributes);?>

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="b_text">Text<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
						    <?php $b_text = array('type'  => 'text', 'name' => 'b_text', 'id' => 'b_text', 'class' => 'form-control col-md-7 col-xs-12');?>
					  ...
					  <div class="form-group">
					   ...
					   <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
						    <?php $b_reason = array('type'  => 'text', 'name' => 'b_reason', 'id' => 'b_reason', 'class' => 'form-control col-md-7 col-xs-12');?>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            <button type="button" id="add_block_text_btn" class="btn btn-success">Add</button>
                        </div>
                      </div>
                    <?php echo form_close();?>
                  </div>
...
<script type="text/javascript">
	$(document).ready(function() {
		$('#add_block_text_btn').click(function(e){
			e.preventDefault();
