          ...
          <div class="">
            ...
            ?></div>
                  <div class="x_content">
                    ...
                    <?php echo form_open("role/add", $attributes);?>
                                                    ...
                                                    foreach($list as $res){
                                                        ...
                                                        <tr class="tab_list_<?php echo $res->id; ?>">        
                                                            ...
                                                            <td>
                                                                <div class="i-checks">
                                                                    <label>
                                                                     <input class="form-control" type="checkbox" name="view_<?php echo $res->id; ?>" id="view_<?php echo $res->id; ?>" value="1">
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                            <div class="i-checks">
                                                                <label>
                                                                    <input class="form-control" type="checkbox" name="add_<?php echo $res->id; ?>" id="add_<?php echo $res->id; ?>" value="1">
                                                                </label>
                                                            </div>
                                                            </td>
                                                            <td>
                                                                <div class="i-checks">
                                                                <label>
                                                                    <input class="form-control" type="checkbox" name="edit_<?php echo $res->id; ?>" id="edit_<?php echo $res->id; ?>" value="1">
                                                                </label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="i-checks">
                                                                <label>
                                                                    <input class="form-control" type="checkbox" name="delete_<?php echo $res->id; ?>" id="delete_<?php echo $res->id; ?>" value="1">
                                                                </label>
                                                                </div>
                                                            </td>
                                                        </tr> 
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            <button type="submit" name="submit" id="save_user" class="btn btn-success">Create Role</button>
                        </div>
                      </div>
                    <?php echo form_close();?>
                  </div>
