	...
	<div class="right_col" role="main">
		<div class="" >
				<div style="background:#eee;" class="page-title">
					<center><h3 style=" padding-bottom:10px;">Strore Product Information</h3></center>
				</div>
						...
						<div class="x_content">
								<div class="row">
									<div class="col-md-12">
										...
										<br>
										<span style="float:left; font-size:13px;">Manufacturer:<?php echo $results->manufacturer;?></span>
										<span style="float:right; font-size:13px;">Price:<?php echo $results->price;?></span>
										<div class="clearfix"></div>
