          ...
          <div class="left_col scroll-view">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              ...
              <ul class="nav child_menu">
                ...
                <li><a><i class="fa fa-users"></i> All Contents <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <?php if(has_permission('post-allcontents')){?> 
                        <li><a href="<?php echo base_url();?>post">Post</a></li>
                        <li><a href="<?php echo base_url();?>post/group_post">Group Post</a></li>
                      <?php }?>
                      <?php if(has_permission('media-allcontents')){?> 
                        <li><a href="<?php echo base_url();?>media">Media Video</a></li>
                      <?php }?>
                      <?php if(has_permission('event-allcontents')){?> 
                        <li><a href="<?php echo base_url();?>events">Event</a></li>
                      <?php }?>
                      <?php if(has_permission('wall_art-allcontents')){?> 
                        <li><a href="<?php echo base_url();?>art">Wall Art</a></li>
                      <?php }?>
                    </ul>
                </li>
              </div>
