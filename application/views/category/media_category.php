          ...
          <div class="">
            <div class="page-title">
                <div class="title_left">
					<h3>Media Gallery Category</h3>
                </div>
			    <div class="title_right">
					<div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right">
					    <div class="input-group">
								<a href="/category/create_category?type=media" class="btn btn-round btn-primary" type="button">Create Category</a>
					    </div>
					</div>
              </div> 
            </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Media Gallery Category</small></h2>
                    ...
                    <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
						...
						<?php if(count($results) > 0){
							...
							<tr>
								...
								<td>
									<div class="btn-group">
										<a href="/category/edit_category?type=media&id=<?php echo $result->id;?>" class="btn btn-warning" title="Edit Category"><i class="fa fa-edit"></i></a>
										<a href="/category/delete_category?type=media&id=<?php echo $result->id;?>" class="btn btn-danger" title="Delete Category"><i class="fa fa-trash"></i></a>
									</div>
								</td>
							</tr>
						<?php } }else{?>	
