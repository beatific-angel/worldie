                  ...
                  <div class="x_content">
					...
					<?php echo form_open(uri_string(), $attributes);?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
						    <?php $password = array('type'  => 'password', 'name' => 'password', 'id' => 'pass', 'class' => 'form-control col-md-7 col-xs-12','value' => '');?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
						    <?php $password_confirm = array('type'  => 'password', 'name' => 'password_confirm', 'id' => 'password_confirm', 'class' => 'form-control col-md-7 col-xs-12','value' => '');?>
					  ...
					  <?php echo form_hidden('submit_action', 'update');?>
                      <div class="ln_solid"></div>
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            <button type="button" id="save_user" class="btn btn-success">Update User</button>
                        </div>
                      </div>
                    <?php echo form_close();?>
                  </div>
