...
class Reported extends Base_Controller {
	...
	public function item_view(){
		...
		} elseif($item_type == 'Media_video_comment'){
            $this->load->view('reportedcontent/item_view_mediavideo_comment', $this->data);
		}
		elseif($item_type == 'Wall_Art'){
            $this->load->view('reportedcontent/item_view_wallart', $this->data);
		}
		elseif($item_type == 'Wall_Art_Comment'){
            $this->load->view('reportedcontent/item_view_wallartcomment', $this->data);
		}
		...
		elseif($item_type == 'Group_Post_Comment'){
            $this->load->view('reportedcontent/item_view_grouppostcomment', $this->data);
		}
		elseif($item_type == 'Store_Product'){
            $this->load->view('reportedcontent/item_view_store_product', $this->data);
		}
		elseif($item_type == 'Store_Product_Comment'){
            $this->load->view('reportedcontent/item_view_store_productcomment', $this->data);
		}
		elseif($item_type == 'Group_Comment'){
            $this->load->view('reportedcontent/item_view_groupcomment', $this->data);
		}
	}
